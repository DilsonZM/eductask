          ...
          <table className="w-full table-fixed">
            ...
            <thead>
              <tr className="border-b border-slate-200 bg-slate-50/50">
                <th className="text-left px-2 py-3 text-xs font-semibold text-slate-400 uppercase tracking-wider">Salón</th>
                <th className="text-left px-2 py-3 text-xs font-semibold text-slate-400 uppercase tracking-wider">Materia</th>
                <th className="text-center px-1 py-3 text-xs font-semibold text-slate-400 uppercase tracking-wider">Tope</th>
                <th className="text-center px-1 py-3 text-xs font-semibold text-slate-400 uppercase tracking-wider">Taller%</th>
                <th className="text-center px-1 py-3 text-xs font-semibold text-slate-400 uppercase tracking-wider">Trab%</th>
                <th className="text-center px-1 py-3 text-xs font-semibold text-slate-400 uppercase tracking-wider">Quiz%</th>
                <th className="text-center px-1 py-3 text-xs font-semibold text-slate-400 uppercase tracking-wider">EFinal%</th>
                <th className="text-center px-1 py-3 text-xs font-semibold text-slate-400 uppercase tracking-wider">Bonus</th>
                <th className="text-center px-1 py-3 text-xs font-semibold text-slate-400 uppercase tracking-wider">Total</th>
              ...
              {rows.map((row) => {
                ...
                return (
                  <tr key={row.classroomSubjId} className={cn("hover:bg-slate-50/50 transition", row.dirty && "bg-amber-50/30")}>
                    <td className="px-2 py-3 text-sm font-semibold text-slate-800 truncate">{row.classroomName}</td>
                    ...
                    <td className="px-2 py-3 text-center">
                      <button onClick={() => handleSave(row)} disabled={savingId === row.classroomSubjId || !isValid}
                        className={cn("inline-flex items-center gap-1 px-2 py-1.5 rounded-lg text-xs font-medium transition-all w-full justify-center",
                        ...
                        ) : row.dirty ? <><Save className="w-3 h-3" /> Guardar</> : <><Check className="w-3 h-3" /></>}
                      </button>
                    </td>
                  </tr>
                );
