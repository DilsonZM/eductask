...
export function Sidebar({ role }: SidebarProps) {
  ...
  return (
    <aside className="w-64 min-h-screen bg-white/95 backdrop-blur border-r border-gray-200 flex flex-col shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
              ...
              {group.links.map((link) => {
                ...
                return (
                  <Link
                    ...
                    href={link.href}
                    className={cn(
                      "group flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 will-change-transform",
                      isActive
